 ...
 * @param state
 */
function isIntentWithDialogState(
  handlerInput: HandlerInput,
  intent: string,
  state: DialogState,
): boolean {
  return (
    skillHelpers.isIntent(handlerInput, intent) &&
    getDialogState(handlerInput.requestEnvelope) === state
  );
}
 ...
 * @param handlerInput
 */
function getDirectiveServiceClient(
  handlerInput: HandlerInput,
